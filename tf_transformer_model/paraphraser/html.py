...
class Paraphraser(object):
    ...
    def __init__(self, checkpoint):
        ...
        checkpoint = "paraphraser/checkpoints/model-171856"
...
def form_post(request: Request, num: str = Form(...)):
    result = app.paraphraser.sample_paraphrase(num, sampling_temp=0.75, how_many=1)[0]
